...
.controller('MenuController', ['$scope',  'favoriteFactory',
    'baseURL', '$ionicListDelegate', 'dishes', '$localStorage', '$ionicPlatform', '$cordovaLocalNotification',
    '$cordovaToast',
    function($scope, favoriteFactory, baseURL, $ionicListDelegate, dishes, $localStorage, $ionicPlatform,
...
.controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'baseURL', '$ionicPopover',
    'favoriteFactory', '$ionicModal', 'menuFactory', '$timeout', '$ionicListDelegate', 'dish' ,'$localStorage','$ionicPlatform', '$cordovaLocalNotification',
    '$cordovaToast',
...
.controller('FavoritesController', ['$scope', 'dishes', 'favorites','favoriteFactory', 'baseURL', 
    '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', '$localStorage', '$cordovaVibration',
